...
#define MyAppDisplayVersion "Public Beta v2.0.4-beta"
#define MyAppFileVersion "2.0.4.0"
...
begin
  ...
  WizardForm.WelcomeLabel2.Caption :=
    ...
    'This beta update completes the current web-to-offline feature parity pass ' +
    'with Report/Event linking, expanded Dashboard statistics, participant ' +
    'attendance, and stronger data-integrity checks.' +
    Chr(13) + Chr(10) + Chr(13) + Chr(10) +
  ...
  WizardForm.FinishedLabel.Caption :=
    ...
    'FIXES INCLUDED' +
    Chr(13) + Chr(10) +
    'This beta update completes the current parity pass with historical Chapter ' +
    'filtering, optional Report/Event links, expanded Dashboard statistics, ' +
    'Members-by-Chapter overview, participant attendance, and validation/audit improvements.' +
    Chr(13) + Chr(10) + Chr(13) + Chr(10) +
